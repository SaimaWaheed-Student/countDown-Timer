...
export default function Countdown() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-black dark:bg-gray-900">
      {/* Timer box container */}
      <div className="bg-gray-500 dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md">
        {/* Title of the countdown timer */}
        <h1 className="text-2xl font-bold mb-4 text-red-800 dark:text-gray-200 text-center">
          Countdown Timer
        </h1>
        ...
        <div className="text-6xl font-bold text-red-800 dark:text-blue-800 mb-8 text-center">
          {formatTime(timeLeft)}
        </div>
        ...
        <div className="flex justify-center gap-4">
          <Button
            onClick={handleStart}
            variant="outline"
            className="text-pink-800 dark:text-gray-200"
          >
